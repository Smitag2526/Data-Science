...
setwd("D:/R Excel Sessions/Day 4")
...
#The reviews are stored in the above folder

# Importing McDonalds reviews data
mcds <- read.csv("/Volumes/Data/Course Content/DS content/Text Mining/Text cleaning-wordcloud/Mcd_Small.csv", header = TRUE)
txt<-mcds$review
