...
#H0:male female % visit in store is same based on week day
#Ha:male female % visit in store is different based on week days
...
#p-value = 8.543e-05 its very less will not accept null hypothesis
