...
companydata <- read.csv("D:/R Excel Sessions/Assignments/Random Forests/Company_data.csv")
...
frauddata <- read.csv("D:/R Excel Sessions/Assignments/Random Forests/Fraud_check.csv")
...
#Let's see what is the optiomum value for number of trees
