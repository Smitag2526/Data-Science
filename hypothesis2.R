...
#p-value=0.051 indicates that null hypothesis is rejected i.e data sets have equal variences
...
#Ha:-avearage TAT of all laboratory are different

Annova_result<-aov(values~ind,data = stacked_data)
summary(Annova_result)

#here p-value of anova test is very less i.e 2e-16 onclude that avg TAT of all labs are diffrent