...
#H0: defective proportion for diffrent centers are same 
#Ha: defective proportion for diffrent centers are different

#since it has more than 2 proportion comparision so we will use chi square test
