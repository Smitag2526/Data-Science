...
salaryData_Train <- read.csv("D:/R Excel Sessions/Assignments/Naive Bayes/SalaryData_Train.csv")
salaryData_Test <- read.csv("D:/R Excel Sessions/Assignments/Naive Bayes/SalaryData_Test.csv")
...
ggplot(newdata,aes(age,colour=Salary))+
...
sms_raw <- read.csv("D:/R Excel Sessions/Assignments/Naive Bayes/sms_raw_NB.csv")
