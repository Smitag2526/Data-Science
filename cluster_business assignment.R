...
library(readxl)
data1 <- read_excel("/R Excel Sessions/Assignments/Clustering/EastWestAirlines.xlsx",sheet="data")
...
#To see the mean values for each group of cluster using agrregate function
...
mydata1 <- read.csv("/R Excel Sessions/Assignments/Clustering/crime_data.csv")
